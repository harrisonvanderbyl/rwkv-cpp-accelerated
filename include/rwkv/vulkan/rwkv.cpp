    ...
    unsigned long long tokenlength, MODE mode = PARRALEL)
{
    ...
    //     // buffer2, 3, 4 = k,v,r
        ...
        cuda_mm8_one(n_emb, n_emb, buffer1, attout, attoutr, attouto, buffer2, i, tokenlength);
        // logData(buffer2, 2, "\natout");
        ...
        cuda_mm8_one(n_emb, n_emb, ffnvbuffer, ffnr, ffnrr, ffnro, buffer2, i, tokenlength);

        

        setx(ffnrbuffer, 0.0, 4*n_emb*tokenlength, EMBSPLIT, EMBBLOCK);
        
        cuda_mm8_one(n_emb, n_emb * 4, ffnkbuffer, ffnk, ffnkr, ffnko, ffnrbuffer, i, tokenlength);
        ...
        cuda_mm8_one(n_emb * 4, n_emb, ffnrbuffer, ffnv, ffnvr, ffnvo, buffer3, i, tokenlength);
    ...
    cuda_mm8_one(n_emb, 50277, buffer1, head, headr, heado, buffer2, 0, tokenlength);
